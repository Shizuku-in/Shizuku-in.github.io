  ...
  e.prototype = {
    ...
    addRibbon: function () {
      ...
      for (var p = [], _ = new h(l, c), d = new h(l, c), u = null, b = Math.round(o(0, 360)), x = 0; !(i <= 0);) {
        if (i--, a = Math.round((1 * Math.random() - 0.2) * this._options.horizontalSpeed), r = Math.round((1 * Math.random() - 0.5) * (0.25 * this._height)), (u = new h).copy(d), "right" === t) {
    ...
    _drawRibbonSection: function (t) {
      if (t) {
        ...
        this._context.fill();
        this._options.strokeSize > 0 && (this._context.lineWidth = this._options.strokeSize, this._context.strokeStyle = s, this._context.lineCap = "round", this._context.stroke());
    ...
    _onResize: function (t) {
      ...
      this._canvas && (this._canvas.width = this._width, this._canvas.height = this._height, this._context && (this._context.globalAlpha = this._options.colorAlpha));
    },
